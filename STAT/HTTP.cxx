...
bool HTTP::request(const char* method, const char* endUrl, const char* data, JsonObject* jOutput, const char* content_type){
    Result result;
...
// Get Json Object on web server.
unsigned int HTTP::request(const char* method, const char* endUrl, const char* data, JsonObject* jOutput, Result& result, const char* content_type){
...
unsigned int HTTP::request(const char* method, const char* endUrl, const char* data, std::string& output, Result& result, const char* content_type){
    ...
    TLockGuard guard(&_requestMutex);
