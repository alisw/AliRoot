...
if(ROOTSYS)
    ...
    if(ALIEN)
        ...
        if(EXISTS "${JALIEN_LIBS}/include")
          ...
          add_definitions(-DALIEN_TYPE=JALIEN)
        elseif(EXISTS "${ALIEN_LIBS}/include")
          message(INFO "ALIEN_LIBS location: ${ALIEN_LIBS}/include")
          include_directories(SYSTEM "${ALIEN_LIBS}/include")
          add_definitions(-DALIEN_TYPE=ALIEN)
        else()
          message(FATAL_ERROR could not determine AliEn flavour)
        endif()
