...
if(ROOTSYS)
    ...
    if(ALIEN)
        ...
        if(EXISTS "${JALIEN_LIBS}/inc")
          message(INFO "JALIEN_LIBS location: ${JALIEN_LIBS}/inc")
          include_directories(SYSTEM "${JALIEN_LIBS}/inc")
        endif()

        if(EXISTS "${ALIEN_LIBS}/inc")
          message(INFO "ALIEN_LIBS location: ${ALIEN_LIBS}/inc")
          include_directories(SYSTEM "${ALIEN_LIBS}/inc")
        endif()
