...
//void AliDecayerExodus::Decay(Int_t idpart, TLorentzVector* pparent, Int_t idpartner)
...
//  Decay(111, &Pizero, dp3[0]->GetPdgCode());
Decay(111+1000*dp3[0]->GetPdgCode(), &Pizero);
  ...
  //Decay(221, &Eta, dp3[0]->GetPdgCode());
  ...
  //Decay(223, &Omegadalitz, dp3[0]->GetPdgCode());
Decay(223+1000*dp3[0]->GetPdgCode(), &Omegadalitz);
  ...
  //Decay(331, &Etaprime, dp3[0]->GetPdgCode());
  ...
  //Decay(333, &Phidalitz, dp3[0]->GetPdgCode());
